    ...
    <div className="min-h-screen bg-[#FDF5E6] text-[#0A192F] font-sans selection:bg-[#1D4A77] selection:text-white relative overflow-hidden">
      ...
      <section className="relative h-[85vh] md:h-screen w-full flex flex-col items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center flex flex-col items-center px-4 mt-20 pointer-events-none">
          ...
          <h1 className="text-[6rem] md:text-8xl lg:text-[9rem] font-serif tracking-tighter leading-none text-[#FDF5E6] drop-shadow-2xl">
            Travis
          </h1>
          <p className="text-4xl md:text-4xl lg:text-[3rem] font-serif tracking-tighter leading-none text-[#FDF5E6] drop-shadow-2xl">
            Uche
          </p>
        </div>
      </section>
      ...
      <section className="py-24 px-8 max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-16 items-start relative">
        ...
        <div className="flex flex-col gap-16 pt-10">
          {[
            ...
            { title: 'The Flame', desc: 'Guided by wisdom, patience, and a vision that inspires generations. The flame represents the steady, unyielding passion.', link: '/flame' },
      ...
      <section className="py-24 max-w-7xl mx-auto px-8 relative">
        <div className="flex flex-col md:flex-row gap-12 mb-20">
          ...
          <div className="w-full md:w-2/3 mt-12 md:mt-24">
            <Image priority src={bio3} alt="Group of friends" className="w-full h-auto md:object-cover rounded-sm shadow-xl hover:grayscale-0 transition-all duration-1000" />
          </div>
        </div>
